        ...
        <aside class="col-sm-6 offset-3">
            <article class="card">
                <div class="card-body p-5">
                    <ul class="nav bg-dark nav-pills rounded nav-fill mb-3" role="tablist">
                        <li class="nav-item">
                            <a class="nav-link active" data-toggle="pill" href="#nav-tab-card">
                            <i class="fa fa-credit-card"></i> CARTE DE CREDIT</a>
                        </li>
                    </ul>
                        ...
                        <div class="tab-pane fade show active" id="nav-tab-card">
                            ...
                            <form role="form" method="POST" id="paymentForm" action="{{ route('payment-store')}}">
                                ...
                                <div class="form-group">
                                    <label for="username">NOM & PRENOM(S)</label>
                                    <input type="text" class="form-control" name="fullName" placeholder="Votre nom et Prénom(S)">
                                </div>
                                <div class="form-group">
                                ...
                                <button class="subscribe btn btn-success btn-block" type="submit"> Confirmer le paiement </button>
                            </form>
                        </div>
                    </div>
                </div>
